...
$applePayMCPPreauth = new ApplePayMCPPreauth();
...
$applePayMCPPreauth->setMCPVersion($mcp_version);
$applePayMCPPreauth->setCardholderAmount($cardholder_amount);
$applePayMCPPreauth->setCardholderCurrencyCode($cardholder_currency_code);
$applePayMCPPreauth->setRateToken($mcp_rate_token);

/**************************** Transaction Object *****************************/

$mpgTxn = new mpgTransaction($applePayMCPPreauth);
