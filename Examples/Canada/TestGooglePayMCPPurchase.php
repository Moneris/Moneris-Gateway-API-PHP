...
$googlePayMCPPurchase = new GooglePayMCPPurchase();
...
$googlePayMCPPurchase->setMCPVersion($mcp_version);
$googlePayMCPPurchase->setCardholderAmount($cardholder_amount);
$googlePayMCPPurchase->setCardholderCurrencyCode($cardholder_currency_code);
$googlePayMCPPurchase->setRateToken($mcp_rate_token);

/**************************** Transaction Object *****************************/

$mpgTxn = new mpgTransaction($googlePayMCPPurchase);
